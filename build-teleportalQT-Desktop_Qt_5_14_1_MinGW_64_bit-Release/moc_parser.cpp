...
#include <memory>
#include "../teleportalQT/dependencies/link/parser.h"
...
QT_MOC_LITERAL(3, 19, 12), // "ping_message"
QT_MOC_LITERAL(4, 32, 3), // "msg"
QT_MOC_LITERAL(5, 36, 10) // "parseError"

    },
    "Parser\0newMessage\0\0ping_message\0msg\0"
    "parseError"
};
...
void Parser::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->newMessage((*reinterpret_cast< const ping_message(*)>(_a[1]))); break;
        ...
        {
            using _t = void (Parser::*)(const ping_message & );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Parser::newMessage)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void Parser::newMessage(const ping_message & _t1)
{
